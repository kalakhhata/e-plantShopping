...
function ProductList() {
   ...
   const styleA={
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowCart(false); // Hide the cart and show plants list
    };

    const handleContinueShopping = (e) => {
        e.preventDefault();
        setShowCart(false); // Hide cart and continue shopping
    };
    ...
    const handleAddToCart = (product) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Mark this product as added to the cart
        }));
    };
